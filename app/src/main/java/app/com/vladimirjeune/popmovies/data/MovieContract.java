...
public final class MovieContract {
    ...
    public static final String PATH_JOIN_YOUTUBE_MOVIES = "youtube_movie_join";
    ...
    public static class YoutubeEntry implements BaseColumns {

        // Base content uri + path
        public static final Uri CONTENT_URI = BASE_CONTENT_URI.buildUpon()
                .appendPath(PATH_YOUTUBE).build();

        public static final String TABLE_NAME = "youtube";

        // We are using _ID from BaseColumns for the ID only for BaseColumns to still work(autoincrement).
        public static final String YOUTUBE_ID = "y_id";  // Too big for INT, but is real ID from website.

        public static final String KEY = "key";

        public static final String NAME = "name";

        public static final String TUBE = "site";  // If other than Youtube; discard.  Don't know how to get data

        public static final String SIZE = "size";  // [360|480|720|1080]

        public static final String TYPE = "type";  // [Trailer|Teaser|Clip|Featurette]

        // Foreign Key to the Movie Table
        public static final String MOVIE_ID = "movie_id";

        /**
         * BUILDURIWITHREVIEWID - Will be used to query details about a single Youtube.
         * adds the id to the end of the review content Uri path.
         * * The AutoIncrement ID is NOT the real ID from TMDb
         * @param id - long - Review ID
         * @return - Uri - [CONTENT_AUTHORITY] + ID
...
//        public static final String MOVIE_ID = "movie_id";
    ...
    // No need to insert, update, or delete.  This is a created table
    // Just query.
    public static class JoinYoutubeEntry implements BaseColumns {

        // Base content uri + path
        public static final Uri CONTENT_URI = BASE_CONTENT_URI.buildUpon()
                .appendPath(PATH_JOIN_YOUTUBE_MOVIES).build();
